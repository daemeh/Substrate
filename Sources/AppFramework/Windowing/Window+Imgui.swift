...
extension ImGui {
    ...
    public static func initialisePlatformInterface() {
        ...
        Task.runDetached { await GPUResourceUploader.replaceTextureRegion(Region(x: 0, y: 0, width: width, height: height), mipmapLevel: 0, in: fontTexture, withBytes: pixels, bytesPerRow: width * bytesPerPixel) }
